...
ProtoMagicCore * FireMagicCore::CreateElement(glm::vec3 position) {
  ElementPiece * obj =  new ElementPiece(new Mesh("resources/textures/fire.png", new Model((char *)"resources/models/fireelement.obj"), 0.2f), true, true, false, true, position, glm::vec3(0.0f, 0.0f, 0.0f), "Fire Element");
