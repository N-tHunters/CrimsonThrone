...
void Mesh::draw(Shader shader, Camera* camera) {
	...
	glm::mat4 projection;
	obj->getRotationX();
	model = glm::rotate(model, glm::radians(obj->getRotationX()), glm::vec3(1.0f, 0.0f, 0.0f));
	model = glm::rotate(model, glm::radians(obj->getRotationY()), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::rotate(model, glm::radians(obj->getRotationZ()), glm::vec3(0.0f, 0.0f, 1.0f));
	...
	view = glm::translate(view, obj->getPosition() - camera->getPosition());
